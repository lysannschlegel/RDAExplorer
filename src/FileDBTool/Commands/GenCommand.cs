...
using RDAExplorer.FileDBTool.Writer;
    ...
    class GenFileDBCommand : ManyConsole.ConsoleCommand
    {
        ...
        public override int Run(string[] remainingArguments)
        {
            ...
            using (var outputStream = new System.IO.FileStream(this.outputFileName, System.IO.FileMode.Create, System.IO.FileAccess.Write)) {
                using (var writer = new RDAExplorer.FileDBTool.Writer.BinaryWriter(outputStream, System.Text.Encoding.Unicode, false)) {
                    this.WriteArchiveMap(writer, tags, fileSystem, remainingArguments);
                    this.WriteTag(writer, tags, "StructureEnd");
                    this.WriteTagsSections(writer, tags);
                }
            }
